...
const AuthProvider = ({ children, initialUserValue }) => {
  ...
  function onData(data) {
    ...
    if (DEBUG_RERENDERS)
      console.log("AuthProvider() newUser", data.authenticatedUser);
...
const withAuth = ({ ssr = false, ...opts } = {}) => (PageComponent) => {
  ...
  SIGNIN_MUTATION = opts.SIGNIN_MUTATION
    ? opts.SIGNIN_MUTATION
    : SIGNIN_MUTATION;
  SIGNOUT_MUTATION = opts.SIGNOUT_MUTATION
    ? opts.SIGNOUT_MUTATION
    : SIGNOUT_MUTATION;
