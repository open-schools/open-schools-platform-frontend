...
type CountDownChildrenType = (
  // TODO(Dimitreee): remove any
  {
    ...
    runAction,
    loading,
  }: { countdown: number; runAction: () => Promise<any>; loading: boolean }
) => JSX.Element;
