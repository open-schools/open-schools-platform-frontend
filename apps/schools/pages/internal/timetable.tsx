...
const TimetableModulePage: React.FC = () => {
    return (
        <>
            <Head>
            ...
            <PageContent>
                <OrganizationRequired>
                    <InternalModuleGuard entry="/internal/timetable">
                        <Card style={{ margin: '24px', textAlign: 'center' }}>
                            <Title level={2}>Модуль Расписание работает</Title>
                            <Paragraph>
...
export default TimetableModulePage
