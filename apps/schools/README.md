...
DOCKER_FILE_BUILD_COMMAND=echo yarn workspace @app/schools build
DOCKER_COMPOSE_APP_IMAGE_TAG=schools
DOCKER_COMPOSE_START_APP_COMMAND=yarn workspace @app/schools start
...
docker-compose run app yarn workspace @app/schools makemigrations

# migrate!
docker-compose run app yarn workspace @app/schools migrate
